...
//!
//! This is the Declorch port of the Hermes Agent multi-destination cron
//! pattern: one job → N destinations (channels / webhooks / files / email).

use futures::future::join_all;
use declorch_channels::bridge::ChannelBridgeHandle;
use declorch_types::scheduler::CronDeliveryTarget;
