//! Configuration types for the Declorch kernel.
...
pub struct DockerSandboxConfig {
    ...
    pub image: String,
    /// Container name prefix. Default: "declorch-sandbox".
...
impl Default for DockerSandboxConfig {
    fn default() -> Self {
        Self {
            ...
            container_prefix: "declorch-sandbox".to_string(),
...
pub struct VaultConfig {
    ...
    pub enabled: bool,
    /// Custom vault file path (default: ~/.declorch/vault.enc).
...
/// - `ChannelMessage::channel_id()` in `declorch-channels::types` (routing-time
...
pub struct ExecPolicy {
    ...
    /// Environment variables to forward from the Declorch process into
...
pub struct KernelConfig {
    /// Declorch home directory (default: ~/.declorch).
    pub home_dir: PathBuf,
    /// Data directory for databases (default: ~/.declorch/data).
    ...
    /// Root directory for agent workspaces. Default: `~/.declorch/workspaces`
    #[serde(default)]
    ...
    /// Defaults to `~/.declorch/workflows`. Set to empty string to disable.
    #[serde(default)]
...
pub struct AuthConfig {
    ...
    /// Generate with: declorch auth hash-password
...
impl Default for KernelConfig {
    fn default() -> Self {
        let home_dir = declorch_home_dir();
        Self {
...
/// Resolve the Declorch home directory.
///
/// Priority: `OPENFANG_HOME` env var > `~/.declorch`.
fn declorch_home_dir() -> PathBuf {
...
pub struct MatrixConfig {
    ...
    /// Bot user ID (e.g., "@declorch:matrix.org").
    pub user_id: String,
...
pub struct IrcConfig {
    ...
    /// Channels to join (e.g., `["#declorch", "#general"]`).
    #[serde(default, deserialize_with = "deserialize_string_or_int_vec")]
...
impl Default for MqttConfig {
    fn default() -> Self {
        Self {
            ...
            client_id: String::new(),
            subscribe_topic: "declorch/inbox".to_string(),
