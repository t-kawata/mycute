...
//! chat (WebSocket).
//!
//! Each dispatch site (there are three: `declorch-cli/src/tui/mod.rs`,
//! `declorch-channels/src/bridge.rs`, `declorch-api/src/ws.rs`) retains its own
...
//!
//! ```
//! use declorch_types::commands::{self, Surfaces};
//!
...
/// Every slash command registered in Declorch.
///
/// Keep this list in sync with the three dispatch sites:
///   - `declorch-cli/src/tui/mod.rs::handle_slash_command`
///   - `declorch-channels/src/bridge.rs::handle_command`
///   - `declorch-api/src/ws.rs::handle_command`
