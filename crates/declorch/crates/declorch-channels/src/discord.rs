//! Discord Gateway adapter for the Declorch channel bridge.
//!
...
async fn parse_discord_message(
    ...
    // Enable with: RUST_LOG=declorch_channels::discord=debug
    debug!(target: "declorch_channels::discord", payload = %d, "discord raw message payload");
...
mod tests {
    ...
    async fn test_parse_discord_mention_detection() {
        ...
        let d = serde_json::json!({
            ...
            "mentions": [{"id": "bot123", "username": "declorch"}],
            "author": {
                "id": "user1",
                "username": "alice",
                "discriminator": "0"
