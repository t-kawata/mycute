...
plan_path: /private/var/folders/y6/l095q825059b0993jps0n6180000gn/T/ticket-script-test-HApk5k/tickets/context/0042-test-ticket/plan.md
implementation_path: /Users/kawata/shyme/mycute/crates/darvium/tickets/context/0042-test-ticket/implementation.md
review_report_path: /Users/kawata/shyme/mycute/crates/darvium/tickets/context/0042-test-ticket/review.md
---
# Test Ticket
...
- 計画: context/0042-test-ticket/plan.md（未作成、/plan-ticket 承認後に作成）
- 実装サマリ: context/0042-test-ticket/implementation.md（未作成、/start-ticket 実装完了後に作成）
- レビュー報告書: context/0042-test-ticket/review.md（未作成、/review-ticket 全チェック通過後に作成）
- 観察レポート: context/0042-test-ticket/observation-YYYYMMDD-HHmmss.md（未作成、/start-ticket 観測テスト実行時に作成。繰り返し実行ごとに新規ファイル）
