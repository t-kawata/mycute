...
- 計画: context/0155-skip-child-search/plan.md（未作成、/plan-ticket 承認後に作成）
- 実装サマリ: context/0155-skip-child-search/implementation.md（未作成、/start-ticket 実装完了後に作成）
- レビュー報告書: context/0155-skip-child-search/review.md（未作成、/review-ticket 全チェック通過後に作成）
- 観察レポート: context/0155-skip-child-search/observation-YYYYMMDD-HHmmss.md（未作成、/start-ticket 観測テスト実行時に作成。繰り返し実行ごとに新規ファイル）
