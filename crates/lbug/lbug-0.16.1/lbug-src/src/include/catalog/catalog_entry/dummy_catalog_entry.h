...
public:
    ...
    void serialize(common::Serializer& /*serializer*/) const override { UNREACHABLE_CODE; }
    std::string toCypher(const ToCypherInfo& /*info*/) const override { UNREACHABLE_CODE; }
};
