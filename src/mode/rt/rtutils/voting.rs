...
use crate::constants::{ST_INTERNAL_SERVER_ERROR, ERR_SERIALIZE_VOTES};
...
pub fn format_vote_payload(
    ...
    Ok(format!("app_id:{},vote:{},vote_allocated:{},timestamp:{},ticket:{}", app_id, vote, vote_allocated, timestamp, ticket_json_str))
}
...
pub fn format_vote_receipt_payload(vote_allocated: i32, timestamp: i64, node_sig: &str) -> String {
    format!("vote_allocated:{},timestamp:{},node_sig:{}", vote_allocated, timestamp, node_sig)
}
