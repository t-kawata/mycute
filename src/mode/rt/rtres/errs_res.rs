    ...
    fn from(e: TransactionError<ApiError>) -> Self {
        match e {
            TransactionError::Connection(db_err) => {
                ApiError::new_system(ST_INTERNAL_SERVER_ERROR, crate::mode::rt::rterr::rterr::ERR_DATABASE, format!("Database error: {}", db_err))
            }
...
impl From<DbErr> for ApiError {
    fn from(e: DbErr) -> Self {
        ApiError::new_system(ST_INTERNAL_SERVER_ERROR, crate::mode::rt::rterr::rterr::ERR_DATABASE, format!("Database error: {}", e))
    }
}
