...
require (
	...
	github.com/cloudwego/eino-ext/components/embedding/ollama v0.0.0-20251216025750-8834f6431b97
	github.com/cloudwego/eino-ext/components/embedding/openai v0.0.0-20251216025750-8834f6431b97
	...
	github.com/cloudwego/eino-ext/components/model/gemini v0.1.18
	github.com/cloudwego/eino-ext/components/model/ollama v0.1.6
	github.com/cloudwego/eino-ext/components/model/openai v0.1.5
	github.com/cloudwego/eino-ext/components/model/openrouter v0.1.0
...
require (
	...
	github.com/cloudwego/eino-ext/libs/acl/openai v0.1.9 // indirect
