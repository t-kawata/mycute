...
pub trait VectorStorage: Send + Sync {
    ...
    // TODO: データ吸収 (Absorb) 機能で追加予定のメソッド
    ...
    // TODO: クエリ (Query) 機能で追加予定のメソッド
    // - search_fts: 全文検索
    // - get_chunk_by_id: チャンク取得

    // TODO: 記憶化 (Memify) 機能で追加予定のメソッド
    // - add_summary: 要約の保存
}
...
pub trait GraphStorage: Send + Sync {
    ...
    // TODO: データ吸収 (Absorb - GraphExtraction) 機能で追加予定のメソッド
    // - add_node: ノードの追加
    // - add_edge: エッジの追加
    ...
    // TODO: 記憶化 (Memify - Metabolism) 機能で追加予定のメソッド
