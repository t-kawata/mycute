...
<g>
	<g>
		<path class="st0" d="M210.094,95.156c9.844,0,19-3,26.594-8.141c-8.031-11.109-12.828-24.719-12.828-39.438
			...
			C162.516,73.844,183.813,95.156,210.094,95.156z" style="fill: rgb(75, 75, 75);"></path>
		<path class="st0" d="M291.469,95.156c26.266,0,47.563-21.313,47.563-47.578C339.031,21.297,317.734,0,291.469,0
			s-47.578,21.297-47.578,47.578C243.891,73.844,265.203,95.156,291.469,95.156z" style="fill: rgb(75, 75, 75);"></path>
		<path class="st0" d="M473.281,240.25c-7.906,6.156-17.469,9.703-27.625,9.703c0,0,0,0-0.016,0
			...
			c38.391-11.5,144.391-30.875,141.031-151.047C505.281,309.313,493.531,272.344,473.281,240.25z" style="fill: rgb(75, 75, 75);"></path>
		<path class="st0" d="M84.453,222.188c39.859-41.656,99.453-69,171.547-69.031c72.094,0.031,131.703,27.375,171.563,69.031
			...
			c-84.891-0.031-158.203,32.609-207.75,84.516c-9.563,10-9.203,25.859,0.797,35.406S74.875,232.188,84.453,222.188z" style="fill: rgb(75, 75, 75);"></path>
	</g>
	<!-- 一番下の領域中央付近にテキストを追加 -->
	<defs>
  ...
  <text x="256" y="385"
        ...
        fill="#ffffff"
        font-weight="bold"
        filter="url(#shadow)">{{ numberToPointStr(total) }}</text>
</g>
</svg>
</template>
<script setup lang="ts">
import { numberToPointStr } from 'src/utils/some'
