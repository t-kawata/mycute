...
impl VectorStorage for LadybugDB {
    ...
    // TODO: Phase 5 (Absorb) で以下のメソッドを実装
    ...
    // TODO: Phase 6 (Query) で以下のメソッドを実装
...
impl GraphStorage for LadybugDB {
    ...
    // TODO: Phase 5 (Absorb - GraphExtraction) で以下のメソッドを実装
    ...
    // TODO: Phase 7 (Memify - Metabolism) で以下のメソッドを実装
