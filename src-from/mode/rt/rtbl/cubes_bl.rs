...
pub async fn create_cube(
    ...
    // 2. ActiveModel 作成
    // --------------------------------
    // Note: Go版では APIキーを暗号化しているが、Phase 3 ではまず基本的な CRUD を確立するため、
    ...
    // --------------------------------
    // 4. TODO: LadybugDB ファイル作成 (Phase 4 以降)
    // --------------------------------
    // --------------------------------
    // 5. 最終レスポンス
    // --------------------------------
...
// Update
// ============================================================
// TODO: Phase 3 では基本 CRUD のみ。Update は後で追加。
...
pub async fn delete_cube(
    ...
    // --------------------------------
    // 2. TODO: LadybugDB ファイルの削除 (Phase 4 以降)
    // --------------------------------
    // --------------------------------
    // 3. 削除の実行
    // --------------------------------
